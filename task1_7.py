def task1_7(MAT_ClusterCentres, MAT_M, MAT_evecs, MAT_evals, posVec, nbins):
    # Input:
    # MAT_ClusterCentres: filename of cluster centre matrix
    # MAT_M     : MAT filename of mean vectors of (K+1)-by-D, where K is
    #             the number of classes (which is 10 for the MNIST data)
    # MAT_evecs : filename of eigenvector matrix of D-by-D
    # MAT_evals : filename of eigenvalue vector of D-by-1
